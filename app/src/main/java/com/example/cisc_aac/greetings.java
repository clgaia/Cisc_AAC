    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(greetings.this, FullscreenActivity.class);
        ...
        word14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(word14.getText().toString().equals("+")){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(greetings.this);
                    builder.setTitle("Enter Text");

                    // Create an EditText view for the dialog
                    final EditText input = new EditText(greetings.this);
