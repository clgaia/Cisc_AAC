...
public class food extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button word1 = findViewById(R.id.food_1);
        Button word2 = findViewById(R.id.food_2);
        Button word3 = findViewById(R.id.food_3);
        Button word4 = findViewById(R.id.food_4);
        Button word5 = findViewById(R.id.food_5);
        Button tone = findViewById(R.id.food_6);
        Button word7 = findViewById(R.id.food_7);
        Button word8 = findViewById(R.id.food_8);
        Button word9 = findViewById(R.id.food_9);
        Button word10 = findViewById(R.id.food_10);
        Button word11 = findViewById(R.id.food_11);
        Button word12 = findViewById(R.id.food_12);
        Button word13 = findViewById(R.id.food_13);
        Button word14 = findViewById(R.id.food_14);
        Button word15 = findViewById(R.id.food_15);
        Button word16 = findViewById(R.id.food_16);
        Button word17 = findViewById(R.id.food_17);
        Button word18 = findViewById(R.id.food_18);
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(food.this, FullscreenActivity.class);
        ...
        word10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(word10.getText().toString().equals("+")){
                    ...
                    final EditText input = new EditText(food.this);
