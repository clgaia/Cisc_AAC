    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(leisure.this, FullscreenActivity.class);
        ...
        word13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (word13.getText().toString().equals("+")) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(leisure.this);
                    builder.setTitle("Enter Text");

                    // Create an EditText view for the dialog
                    final EditText input = new EditText(leisure.this);
