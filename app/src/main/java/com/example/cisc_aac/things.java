...
public class things extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button word1 = findViewById(R.id.things_1);
        Button word2 = findViewById(R.id.things_2);
        Button word3 = findViewById(R.id.things_3);
        Button word4 = findViewById(R.id.things_4);
        Button word5 = findViewById(R.id.things_5);
        Button tone = findViewById(R.id.things_6);
        Button word7 = findViewById(R.id.things_7);
        Button word8 = findViewById(R.id.things_8);
        Button word9 = findViewById(R.id.things_9);
        Button word10 = findViewById(R.id.things_10);
        Button word11 = findViewById(R.id.things_11);
        Button word12 = findViewById(R.id.things_12);
        Button word13 = findViewById(R.id.things_13);
        Button word14 = findViewById(R.id.things_14);
        Button word15 = findViewById(R.id.things_15);
        Button word16 = findViewById(R.id.things_16);
