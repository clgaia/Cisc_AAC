...
public class myself extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button word1 = findViewById(R.id.myself_1);
        Button word2 = findViewById(R.id.myself_2);
        Button word3 = findViewById(R.id.myself_3);
        Button word4 = findViewById(R.id.myself_4);
        Button word5 = findViewById(R.id.myself_5);
        Button tone = findViewById(R.id.myself_6);
        Button word7 = findViewById(R.id.myself_7);
        Button word8 = findViewById(R.id.myself_8);
        Button word9 = findViewById(R.id.myself_9);
        Button word10 = findViewById(R.id.myself_10);
        Button word11 = findViewById(R.id.myself_11);
        Button word12 = findViewById(R.id.myself_12);
        Button word13 = findViewById(R.id.myself_13);
        Button word14 = findViewById(R.id.myself_14);
        Button word15 = findViewById(R.id.myself_15);
        Button word16 = findViewById(R.id.myself_16);
        Button word17 = findViewById(R.id.myself_17);
        Button word18 = findViewById(R.id.myself_18);
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(myself.this, FullscreenActivity.class);
        ...
        word14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(word14.getText().toString().equals("+")){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(myself.this);
                    builder.setTitle("Enter Text");

                    // Create an EditText view for the dialog
                    final EditText input = new EditText(myself.this);
