...
public class people extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button word1 = findViewById(R.id.people_1);
        Button word2 = findViewById(R.id.people_2);
        Button word3 = findViewById(R.id.people_3);
        Button word4 = findViewById(R.id.people_4);
        Button word5 = findViewById(R.id.people_5);
        Button tone = findViewById(R.id.people_6);
        Button word7 = findViewById(R.id.people_7);
        Button word8 = findViewById(R.id.people_8);
        Button word9 = findViewById(R.id.people_9);
        Button word10 = findViewById(R.id.people_10);
        Button word11 = findViewById(R.id.people_11);
        Button word12 = findViewById(R.id.people_12);
        Button word13 = findViewById(R.id.people_13);
        Button word14 = findViewById(R.id.people_14);
        Button word15 = findViewById(R.id.people_15);
        Button word16 = findViewById(R.id.people_16);
        Button word17 = findViewById(R.id.people_17);
        Button word18 = findViewById(R.id.people_18);
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(people.this, FullscreenActivity.class);
...
//              TODO: Add popup with tone selection options and append to end of list
        ...
        word9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(word9.getText().toString().equals("+")){
                    // Create an AlertDialog builder
                    AlertDialog.Builder builder = new AlertDialog.Builder(people.this);
                    builder.setTitle("Enter Text");
        ...
        word10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(word10.getText().toString().equals("+")){
                    // Create an AlertDialog builder
                    AlertDialog.Builder builder = new AlertDialog.Builder(people.this);
                    builder.setTitle("Enter Text");
        ...
        word11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(word11.getText().toString().equals("+")){
                    // Create an AlertDialog builder
                    AlertDialog.Builder builder = new AlertDialog.Builder(people.this);
                    builder.setTitle("Enter Text");
