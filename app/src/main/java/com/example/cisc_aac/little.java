...
public class little extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button word1 = findViewById(R.id.little_1);
        Button word2 = findViewById(R.id.little_2);
        Button word3 = findViewById(R.id.little_3);
        Button word4 = findViewById(R.id.little_4);
        Button word5 = findViewById(R.id.little_5);
        Button tone = findViewById(R.id.little_6);
        Button word7 = findViewById(R.id.little_7);
        Button word8 = findViewById(R.id.little_8);
        Button word9 = findViewById(R.id.little_9);
        Button word10 = findViewById(R.id.little_10);
        Button word11 = findViewById(R.id.little_11);
        Button word12 = findViewById(R.id.little_12);
        Button word13 = findViewById(R.id.little_13);
        Button word14 = findViewById(R.id.little_14);
        Button word15 = findViewById(R.id.little_15);
        Button word16 = findViewById(R.id.little_16);
        Button word17 = findViewById(R.id.little_17);
        Button word18 = findViewById(R.id.little_18);
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(little.this, FullscreenActivity.class);
        ...
        word17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(word17.getText().toString().equals("+")){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(little.this);
                    builder.setTitle("Enter Text");

                    // Create an EditText view for the dialog
                    final EditText input = new EditText(little.this);
