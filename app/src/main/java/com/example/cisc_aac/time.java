...
public class time extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button word1 = findViewById(R.id.time_1);
        Button word2 = findViewById(R.id.time_2);
        Button word3 = findViewById(R.id.time_3);
        Button word4 = findViewById(R.id.time_4);
        Button word5 = findViewById(R.id.time_5);
        Button tone = findViewById(R.id.time_6);
        Button word7 = findViewById(R.id.time_7);
        Button word8 = findViewById(R.id.time_8);
        Button word9 = findViewById(R.id.time_9);
        Button word10 = findViewById(R.id.time_10);
        Button word11 = findViewById(R.id.time_11);
        Button word12 = findViewById(R.id.time_12);
        Button word13 = findViewById(R.id.time_13);
        Button word14 = findViewById(R.id.time_14);
        Button word15 = findViewById(R.id.time_15);
        Button word16 = findViewById(R.id.time_16);
        Button word17 = findViewById(R.id.time_17);
        Button word18 = findViewById(R.id.time_18);
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(time.this, FullscreenActivity.class);
        ...
        word13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(word13.getText().toString().equals("+")){
                    ...
                    final EditText input = new EditText(time.this);
